            ...
            <div className="space-y-2">
              ...
              {ready ? (
                <div className="space-y-2">
                  ...
                  <button
                    onClick={copyLink}
                    className="flex items-center gap-3 w-full bg-transparent border border-white/10 text-white/50 rounded-xl px-4 py-3 hover:text-white/70 hover:border-white/20 active:scale-[0.98] transition-all cursor-pointer"
                  >
